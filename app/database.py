...
# --- HIER BEGINNT DER NEUE CODE FÜR _init_db ---
def _init_db():
...
def get_merged_config():
    # Standard-Werte, falls DB versagt
    default_config = {
        "outlier_min": "120", 
        "outlier_max": "7200",
        "ignore_outliers": "false"
    ...
    # WICHTIG: Wenn conn None ist (weil _init_db gescheitert ist),
    # dürfen wir nicht versuchen, SQL auszuführen -> Absturz verhindern!
    if conn is None:
        logging.warning("DB nicht verbunden - Nutze Default Config")
        return default_config

    try:
        # Hier rufst du deine existierende Logik auf
        # (Ich nehme an, du hast eine get_app_config Funktion)
